...
var connectionString = 'localhost/ambition',
  ...
  db = mongojs(connectionString, ['people','postcodeLookup','nspl']);
...
/**
 * Get internet rating from the postcode database.
 */
module.exports.getPostCodeInfo = function (postcode, callback) {
	db.postcodeLookup.findOne({'postcode' : postcode}, callback);

}

module.exports.getPostCodeNSPL = function(postcode, callback){
    db.nspl.findOne({'postcode' : postcode}, callback);
}
