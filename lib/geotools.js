...
module.exports.prototype.getGridRef = function(precision)
{
	...
	var prefix=module.exports.prefixes[y][x];
...
module.exports.prototype.parseGridRef = function(landranger)
{
	...
	for (precision=5; precision>=1; precision--)
	{
		...
		if (gridRef)
		{
			...
			var x,y;
			search: for(y=0; y<module.exports.prefixes.length; y++) 
			{
				for(x=0; x<module.exports.prefixes[y].length; x++)
					if (module.exports.prefixes[y][x] == gridSheet) {
