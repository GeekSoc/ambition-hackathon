...
exports.prototype.setGridCoordinates = function(eastings,northings)
{
...
exports.prototype.setError = function(msg)
{
	this.status=msg;
}

exports.prototype._zeropad = function(num, len)
{
...
exports.prototype.getGridRef = function(precision)
{
	...
	var prefix=exports.prefixes[y][x];
	
    return prefix+" "+this._zeropad(e, precision)+" "+this._zeropad(n, precision);
}

exports.prototype.parseGridRef = function(landranger)
{
	var ok=false;
	...
	for (precision=5; precision>=1; precision--)
	{
		...
		if (gridRef)
		{
			...
			var x,y;
			search: for(y=0; y<exports.prefixes.length; y++) 
			{
				for(x=0; x<exports.prefixes[y].length; x++)
					if (exports.prefixes[y][x] == gridSheet) {
...
exports.prototype.getWGS84 = function()
{
