...
module.exports.prefixes = new Array (
...
module.exports.prototype.setGridCoordinates = function(eastings,northings)
{
...
module.exports.prototype.setError = function(msg)
{
	this.status=msg;
}

module.exports.prototype._zeropad = function(num, len)
{
...
module.exports.prototype.getGridRef = function(precision)
{
...
module.exports.prototype.parseGridRef = function(landranger)
{
	var ok=false;
...
module.exports.prototype.getWGS84 = function()
{
