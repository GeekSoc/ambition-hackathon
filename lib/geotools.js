...
/*****************************************************************************
*
* exports.GT_OSGB holds OSGB grid coordinates
*
*****************************************************************************/

module.exports = function GT_OSGB()
{
	this.northings=0;
	this.eastings=0;
...
exports.GT_OSGB.prefixes = new Array (
...
exports.GT_OSGB.prototype.setGridCoordinates = function(eastings,northings)
{
...
exports.GT_OSGB.prototype.setError = function(msg)
{
	this.status=msg;
}

exports.GT_OSGB.prototype._zeropad = function(num, len)
{
...
exports.GT_OSGB.prototype.getGridRef = function(precision)
{
	...
	var prefix=exports.GT_OSGB.prefixes[y][x];
	
    return prefix+" "+this._zeropad(e, precision)+" "+this._zeropad(n, precision);
}

exports.GT_OSGB.prototype.parseGridRef = function(landranger)
{
	var ok=false;
	...
	for (precision=5; precision>=1; precision--)
	{
		...
		if (gridRef)
		{
			...
			var x,y;
			search: for(y=0; y<exports.GT_OSGB.prefixes.length; y++) 
			{
				for(x=0; x<exports.GT_OSGB.prefixes[y].length; x++)
					if (exports.GT_OSGB.prefixes[y][x] == gridSheet) {
...
exports.GT_OSGB.prototype.getWGS84 = function()
{
